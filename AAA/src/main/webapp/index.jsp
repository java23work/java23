...
<header>
	<div class="container">
		...
		<a target="_blank" href="http://localhost:8080/MavenVideo/adminLogin.jsp"><img src="z/we.png" draggable="false">后台管理</a>
        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tbody><tr>
                        <td colspan="2">
                            <a href="http://localhost:8080/MavenVideo/html5.jsp">
	...
	<div class="mask_content">
		...
		<div class="mask_content_body">
			<form id="login" action="${pageContext.request.contextPath}/login" method="post">
				<h3>快速登录</h3>
				<input id="accounts" placeholder="请输入邮箱" name="accounts" type="email">
...
<div class="mask hidden" id="reg">
	<div class="mask_content">
		...
		<div class="mask_content_body">
			<form id="add" action="${pageContext.request.contextPath}/add" method="post">
				<h3>新用户注册</h3>
				<input id="accounts" placeholder="请输入邮箱" name="accounts" type="email"><span id="emailMsg"></span>
				<input id="password" placeholder="请输入密码" name="password" type="password">
				<input id="password2" placeholder="请再次输入密码" name="password2" type="password"><span id="passMsg"></span>
